# Motif ES 3-Band EQ Curves

This dataset maps the hardware response curves of the integrated 3-band
Equalizer on a 2003 Yamaha Motif ES physical synthesizer workstation.
...
### `Motif EQ Calibration.numbers`
The original Numbers spreadsheet used to assemble the two CSVs above, kept for reference.
